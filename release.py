"""Release data for CooperativeGames.
...
"""
    if not filename:
        filename = os.path.join(
            os.path.dirname(__file__), 'CooperativeGames', 'version.py')
...
def write_versionfile():
    ...
    text = '''"""
Version information for CooperativeGames, created during installation by
setup.py.
...
data."""
long_description = """
Package to study Cooperative Games in the context of Game Theory.
...
keywords = ['math', 'game theory', 'Mathematics']
